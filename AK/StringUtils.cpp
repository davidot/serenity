...
#ifndef KERNEL
template<typename T>
Optional<T> convert_to_double(StringView str, TrimWhitespace trim_whitespace)
{
...
template Optional<double> convert_to_double(StringView str, TrimWhitespace);
template Optional<float> convert_to_double(StringView str, TrimWhitespace);
#endif
